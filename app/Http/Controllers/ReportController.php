...
class ReportController extends Controller
{
    ...
    public function mainpage(){
        ...
        return view('Admin.ManageReport.ReportMainPage',['report_data'=> $report_data]);
    }
    ...
    public function view($id){
        ...
        return view('Admin.ManageReport.ViewReportForm',['report_data'=> $report_data]);
    }

    // this controller will retrieve report id and display it to user for edit
    public function edit($id){
        $report_data = \App\Models\ReportModel::find($id);
        return view('Admin.ManageReport.EditReportForm',['report_data'=> $report_data]);
    }
